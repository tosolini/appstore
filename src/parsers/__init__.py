...
class DockerComposeParser:
    ...
    def parse_compose_content(
        ...
        """
        Parse docker-compose content and extract app metadata.

        Args:
            compose_content: Raw docker-compose.yml content
            app_id: ID app
            repository_source: Display name of the source repository
            source_url: Optional repository/source URL
        ...
        try:
            ...
            source_url = casaos_meta.get('source_url') or source_url
            homepage = casaos_meta.get('homepage') or homepage
            ...
            print(f"Error parsing compose content for {app_id}: {e}")
            return None
    ...
    def parse_app(compose_path: str, app_id: str, repository_source: str) -> Optional[App]:
        ...
        try:
            ...
            return DockerComposeParser.parse_compose_content(
                compose_content=compose_content,
                app_id=app_id,
                repository_source=repository_source
            )
